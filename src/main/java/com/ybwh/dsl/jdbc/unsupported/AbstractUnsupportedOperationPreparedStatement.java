 ...
 * @author zhangliang
 */
public abstract class AbstractUnsupportedOperationPreparedStatement extends WrapperAdapter
	...
	@Override
	public final void setNCharacterStream(final int parameterIndex, final Reader x, final long length)
			throws SQLException {
		throw new SQLFeatureNotSupportedException("setNCharacterStream");
	}
